...
- Fixed the automated build so it actually finds the project file.

## v1.0.1

- First release on GitHub.
- Renamed the project from "Smart Drop Zone Pro" to "Smart Drop Zone".
- Added automatic cloud builds and downloadable releases.
